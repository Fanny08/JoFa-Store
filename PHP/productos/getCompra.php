...
if($_SESSION["inicio"] == false){
	...
	if($consultaSQL){
		...
		while($raw = $consultaSQL -> fetch_assoc())
		{
		 ...
		 $mensaje = "Hola $Usuario, Tu compra es: $PVendidos el total de la compra es: $Total <br> Realiza tu pago en oxxo a este numero de cuenta 5514 8520 1690 2605 lo más pronto posible, los producto llegaran a tu domicilio 2 dias despues de tu pago.";
