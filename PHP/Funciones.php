...
function enviarCorreo($usuario, $titulo, $mensaje, $correo)
{
	...
	try
	{
		...
		$mail->Username = 'jofastore@gmail.com';
		$mail->Password = 'J0f4St0r3';
		$mail->SMTPSecure = 'tls';
		$mail->Port = 587;

		//Recipients
		$mail->setFrom('jofastore@gmail.com', "Jofa Store - $titulo");
		...
		<head>
			<style>
				...
				.footer {padding-top:30px; padding-bottom:30px; padding-left:50px; margin-left: 25%; margin-right: 25%;  background-color: #517ed0; color: #ffe}
				.footer a {color: #ffe}
		...
		<body>
			<div class='pagina'>
				<div class='Titulo'><font color='#517ed0'>JoFa</font><font color='#874ab5'>Store <i class='fas fa-store'></i></font> <div class='subTitulo'>$usuario</div></div>
				<hr>
